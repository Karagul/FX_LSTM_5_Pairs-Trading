...
try:
    ...
    # Change different configurations by choosing different json files
    with open("config_9.json", "r") as f:
        configs = json.load(f)
...
print("System CAGR: %.1f" % (system_metrics[0]*100), "%")
print("System Sharpe: %.1f" %system_metrics[1])

print("Market CAGR: %.1f" % (market_metrics[0]*100), "%")
print("Market Sharpe: %.1f" % (market_metrics[1]))
